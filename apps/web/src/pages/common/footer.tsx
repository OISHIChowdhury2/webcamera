...
<footer className=' w-full text-center border-t border-grey p-4 pin-b'>
    <div className="py-7   px-7 bg-gray-900 dark:bg-gray-100 
     md:flex md:items-center md:justify-between">
        <span className="fixed text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
